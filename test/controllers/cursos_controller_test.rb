...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference("Curso.count") do
      post cursos_url, params: { curso: { costo: @curso.costo, horas: @curso.horas, temas: @curso.temas, titulo: @curso.titulo } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { costo: @curso.costo, horas: @curso.horas, temas: @curso.temas, titulo: @curso.titulo } }
